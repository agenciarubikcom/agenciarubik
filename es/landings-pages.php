...
<div class="section mt-5">
    <div class="container">
        <div class="agenciarubik-section-title ">
            ...
            <h3 class="mb-3">¿Qué es una Landing Page?</h3>
...
<div class="section mb-5">
    ...
    <div class="agenciarubik-accordion-wrap agenciarubik-accordion-wrap2" id="agenciarubik-accordion">
        <div class="agenciarubik-accordion-item open">
          <div class="agenciarubik-accordion-header">
            <h3>Diseño personalizado y orientado a la conversión</h3>
        ...
        <div class="agenciarubik-accordion-item">
          <div class="agenciarubik-accordion-header">
            <h3>Cumplimiento de estándares de SEO, performance y accesibilidad</h3>
            <div class="agenciarubik-active-icon">
              <img src="../assets/images/v3/plus.png" width="18px" alt="+">
            </div>
            <div class="agenciarubik-inactive-icon">
        ...
        <div class="agenciarubik-accordion-item">
          <div class="agenciarubik-accordion-header">
            <h3>Soporte continuo y análisis de rendimiento</h3>
            <div class="agenciarubik-active-icon">
              <img src="../assets/images/v3/plus.png" width="18px" alt="+">
            </div>
            <div class="agenciarubik-inactive-icon">
  ...
  <div class="section my-2">
    ...
    <div class="agenciarubik-v3-thumb">
        <img width="500px" src="/assets/images/landings-pages.svg" title="Landings Pages" alt="Landings Pages">
    </div>
    </div>
    <div class="col-lg-7">
        <div class="agenciarubik-section-title">
        <h2 class="mb-5">Transforma visitantes en clientes con nuestras Landing Pages</h2>
