<?php include "header.php" ?>
      ...
      <div class="row">
        <div class="col-xl-4 col-md-6">
          <div class="agenciarubik-iconbox-wrap-left iconbox-left-border">
            <div class="agenciarubik-iconbox-icon none-bg">
            ...
            <div class="agenciarubik-iconbox-data data-small">
              ...
              <a class="agenciarubik-iconbox-btn" href="single-service.html"> <span>Read more</span> <img src="assets/images/icon/arrow-right2.svg" alt=""></a>
            </div>
          </div>
        </div>
        <div class="col-xl-4 col-md-6">
      ...
      <div class="row agenciarubik-pricing-four-column" id="table-price-value" data-pricing-dynamic data-value-active="monthly">
        <div class="col-xl-3 col-md-6">
          <div class="agenciarubik-pricing-wrap">
            ...
            <a class="agenciarubik-pricing-btn" href="pricing.html">Try it for free</a>
          </div>
        </div>
        <div class="col-xl-3 col-md-6">
          <div class="agenciarubik-pricing-wrap">
        ...
        <div class="col-xl-3 col-md-6">
          <div class="agenciarubik-pricing-wrap active">
            ...
            <a class="agenciarubik-pricing-btn active" href="pricing.html">Try it for free</a>
          </div>
        </div>
        <div class="col-xl-3 col-md-6">
          <div class="agenciarubik-pricing-wrap">
  ...
  <div class="section agenciarubik-section-padding bg-light">
    <div class="container">
      <div class="agenciarubik-section-title agenciarubik-two-column-title">
        <div class="row">
          <div class="col-lg-8">
          ...
          <div class="col-lg-4 d-flex align-items-center">
            <div class="agenciarubik-title-btn">
              <a class="agenciarubik-default-btn pill" href="integrations.html">
      ...
      <div class="agenciarubik-video-column">
        <div class="row">
          <div class="col-lg-6">
            <div class="agenciarubik-video-wrap">
              <img src="assets/images/v3/video-bg.png" alt="">
              <a class="video-init agenciarubik-review-video" href="https://www.youtube.com/watch?v=SixdAQtWJQ8">
          ...
          <div class="col-lg-6 d-flex align-items-center">
            <div class="agenciarubik-testimonial-content">
              <ul>
              ...
              <div class="agenciarubik-testimonial-authors-wraps">
                <div class="agenciarubik-testimonial-authors">
                  <p>Jonas Aly</p>
                  <span>Founder @ Sitemark</span>
                </div>
                <div class="agenciarubik-testimonial-author-logo">
